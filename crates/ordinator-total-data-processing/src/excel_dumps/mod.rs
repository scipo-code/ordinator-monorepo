...
// impl AllRows
// {
//     fn make_xlsx_dump(&self, asset: Asset) -> Result<PathBuf,
...
//             worksheet
//                 .write(row_number, 8,
// row_values.description_work_order.clone())                 .unwrap();
//             worksheet
//                 .write(row_number, 9,
// row_values.operation_short_text.clone())                 .unwrap();
//             worksheet
...
//             worksheet
//                 .write(row_number, 17,
// row_values.earliest_start_date.clone())                 .unwrap();
//             worksheet
//                 .write(row_number, 18,
// row_values.earliest_finish_date.clone())                 .unwrap();
//             worksheet
//                 .write(
//                     row_number,
//                     19,
...
//             // worksheet
//             //     .write(row_number, 22,
// row_values.opperation_system_status.clone())             //     .unwrap();
//             // worksheet
//             //     .write(row_number, 23,
// row_values.opereration_user_status.clone())             //     .unwrap();
//             worksheet
//                 .write(row_number, 22,
// row_values.functional_location.clone())                 .unwrap();
//             worksheet
//                 .write(row_number, 23,
// row_values.description_operation.clone())                 .unwrap();
//             worksheet
...
//             "The excel dump directory environment path could not be found.
// Check the .env file",         );
...
//     let work_orders_by_asset: Vec<(WorkOrderNumber, WorkOrder)> = work_orders
//         .inner
//         .into_iter()
...
// description_work_order: work_order                     .work_order_info
//                     .work_order_text
//                     .order_description
//                     .clone(),
...
//                     .clone()
//                     .unwrap_or("WE DO NOT HAVE THIS FIELD FROM SAP
// YET".to_string()),                 material_status:
// (&work_order.work_order_analytic.user_status_codes).into(),
...
// work: activity.1.operation_info.work_remaining,                 actual_work:
// activity.1.operation_info.work_actual,                 unloading_point:
// activity.1.unloading_point.clone(),                 basic_start_date:
// work_order.work_order_dates.basic_start_date.into(),
...
// work_order.status_codes().clone(),                 // operation_user_status:
// work_order.status_codes().clone(),                 functional_location:
// work_order.functional_location().clone(),
// description_operation: work_order                     .work_order_info
//                     .work_order_text
//                     .operation_description
//                     .clone()
//                     .unwrap_or("WE DO NOT HAVE THIS SAP FIELD
// YET".to_string()),                 subnetwork_of: work_order
//                     .work_order_info
//                     .work_order_info_detail
//                     .subnetwork
//                     .clone(),
//                 system_condition:
// work_order.work_order_info.system_condition.clone(),
// maintenance_plan: work_order                     .work_order_info
//                     .work_order_info_detail
//                     .maintenance_plan
//                     .clone(),
