...
{
    let work_order_datas = vec![WorkOrderData {
        work_order_number: WorkOrderNumber(1000990000),
        priority: WorkOrderType::Wdf(Priority::Int(3)),
        work_remaining: vec![(10, 5.0), (20, 5.0), (30, 5.0)],
    }];
