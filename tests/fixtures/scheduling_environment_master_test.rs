...
// fn work_order_builder(wo_builder: WorkOrdersBuilder) -> WorkOrdersBuilder
// {
//     wo_builder
...
// .operation_dates(|dates| {                             dates
//                                 .earliest_start_from_ymd_hms(2025, 1, 1, 7,
// 0, 0)                                 .earliest_finish_from_ymd_hms(2025, 1,
// 2, 7, 0, 0)                         })
//                         .operation_analytic(|oab|
// oab.duration(1.0).preparation_time(1.0))                 })
...
// notes_1: Some("TEST".to_string()),                             notes_2:
// Some(1),                         })
//                         .functional_location_from_str("TEST/XX/XX/101")
//                         .system_condition(SystemCondition::A)
//                         // It is clear that you need a thorough understanding
// of the whole                         // maintenance process to be able to
// develop this system.                         
// .work_order_info_detail(WorkOrderInfoDetail {                             
// subnetwork: "123".to_string(),                             maintenance_plan:
// "PLAN TEST".to_string(),                             planner_group:
// "TEST_GROUP".to_string(),                             maintenance_plant:
// "TEST".to_string(),                             pm_collective:
// "TEST".to_string(),                             room:
// "TEST_ROOM".to_string(),                         })
//                 })
...
// fn worker_builder(actor_builder: ActorSpecificationBuilder) ->
...
//                     .supervisor_options(|f|
// f.number_of_unassigned_work_orders(10))             })
//         })
...
//                                 .break_interval(TimeInterval::from_hms(11, 0,
// 0, 12, 0, 0).unwrap())                                 .off_shift_interval(
//                                     TimeInterval::from_hms(19, 0, 0, 7, 0,
// 0).unwrap(),                                 )
//                                 .toolbox_interval(TimeInterval::from_hms(7,
// 0, 0, 8, 0, 0).unwrap())                         })
...
//                                 // THIS IS WHAT YOU SHOULD NOT DO! Each you
// are spilling out 3 types                                 // that should be
// encapsulated.
