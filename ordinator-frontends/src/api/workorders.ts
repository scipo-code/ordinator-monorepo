import type { SchedulingData } from "@/pages/supervisor/ScheduleView.tsx";
import { apiConfig } from "./config.ts";
import type { PeriodDto } from "@/types/dto/PeriodDto.ts";
import type { WorkOrderInfoWithSchedulingDto } from "@/types/dto/WorkOrderInfoWithSchedulingDto.ts";
