...
import type { WorkOrderInfoWithSchedulingDto } from "@/types/dto/WorkOrderInfoWithSchedulingDto";
import type { PeriodDto } from "@/types/dto/PeriodDto";
import { PeriodStatusBadge } from "@/components/business/PeriodStatusBadge";
import { PeriodAssignment } from "@/components/business/PeriodAssignment";
import { TacticalDayAssignment } from "@/components/business/TacticalDayAssignment";
import { useVersionChangeDetector } from "@/hooks";
...
function assignWorkOrderToPeriod(_asset: string, _workorder: string, _period: string): Promise<unknown> {
