...
if test "$_flag_ordinator_test"
    ...
    if $_flag_average_objectives
        ...
        gnuplot -e "
          ...
          output_file='$current_date-$_flag_ordinator_test.png';
